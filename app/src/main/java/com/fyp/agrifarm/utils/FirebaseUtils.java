...
public class FirebaseUtils {
    ...
    static final CollectionReference firestoreUsers = FirebaseFirestore.getInstance().collection("users");
    static final StorageReference storageReference = FirebaseStorage.getInstance().getReference("userImages");
    static final String TAG = "FirebaseUtils";

    static final FirebaseUtils ourInstance = new FirebaseUtils();
...
//        );
    ...
    public static void loadUserProfileImage(Context ctx, String url, ImageView targetImageView, Resources resources){
